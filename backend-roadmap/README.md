...
1. [言語を選ぶ](./01-pick-a-language.md)
1. [言語の基礎を学び、CLI を作成する](./02-practice-what-you-learnt.md)
1. [パッケージマネージャについて学ぶ](./03-learn-package-manager.md)
1. [業界標準のコーディング規約と関連するツールを学ぶ](./04-standards-and-best-practices.md)
1. [パッケージを作って公開する](./05-make-and-distribute-package.md)
